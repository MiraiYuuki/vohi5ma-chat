    ...
    socket.onmessage = function(e) {
        ...
        if(data.type == 'typing') {
            ...
            if(usersTyping.length == 1) {
                string = usersTyping + ' sedang mengetik...';
            } else if(usersTyping.length > 1) {
                string = 'Beberapa orang sedang mengetik...';
            } else if(usersTyping.length > 1) {
    ...
    speechToText.onresult = function(event) {
        ...
        for (var i = event.resultIndex; i < event.results.length; ++i) {
            if (event.results[i].isFinal) {
                ...
                updateBar('mdi-content-send', 'Masukan Text Disini ...', false);
                speechToText.stop();
                handleInput();
            } else {
...
function desktopNotif(message) {
    ...
    var notification = new Notification('Anda mendapatkan pesan baru', {
